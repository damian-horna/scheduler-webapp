...
<body>
	<div class="container">
				...
				<div class="sidebar">
					...
					<div class="option"><a href="settings.php" style="box-shadow: inset 0 0 30px #000;"><i class="icon-cog-alt"></i><br/>Settings</a></div>
				</div>

				<div class="todayContent">
						<h1>Settings</h1>
						<div class="calendar">
							<div id="logoutButton"><a href="logout.php" style="color: black; ">Log out</a>
							</div>
						</div>
				</div>
