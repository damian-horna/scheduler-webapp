	...
	<div class="container">
				...
				<div class="todayContent">
						...
						<div class="todayMenu">
							...
							<div class="todayopt" id="editopt" style="background-color: #221356;"><a href=<?php echo "\"editwhenever.php?date=". $_GET['date'] . "\""; ?>><i class="icon-edit-1"></i></a></div>
							<div class="todayopt" id="deleteopt"><a href=<?php echo "\"deletewhenever.php?date=". $_GET['date'] . "\""; ?>><i class="icon-trash-empty"></i></a></div>
						</div>
									...
									if ($res = @$connection->query($sql))
									{
										if ($res->num_rows > 0) {
										    while($row = $res->fetch_assoc()) {
										        echo "<div class=\"editme\"><a id=\"toedit\" href=\"anyedit.php?id=". $row['id']. "&desc=". $row['task']. "&time=". $row['time']. "&date=". $_GET['date']. "\"> <span style=\"text-align: center;\">".$row['time']. "</span><br/>". $row['task']. "</a></div>";
										    }
										}
										$res->free_result();
									}
