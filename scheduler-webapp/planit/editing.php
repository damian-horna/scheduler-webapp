...
<body>
	<div class="container">
				...
				<div class="todayContent">
						...
						<div class="todayMenu">
							<div class="todayopt"> <a href="adding.php"><i class="icon-doc-add"></i></a></div>
							<div class="todayopt" style="box-shadow: inset 0 0 40px #221356;" ><a href="editing.php"><i class="icon-edit-1"></i></a></div>
							<div class="todayopt"><a href="deleting.php"><i class="icon-trash-empty"></i></a></div>
						</div>
									...
									if ($res = @$connection->query($sql))
									{
										if ($res->num_rows > 0) {
										    while($row = $res->fetch_assoc()) {
										        echo "<div class=\"editme\"><a id=\"toedit\" href=\"edit.php?id=". $row['id']. "&desc=". $row['task']. "&time=". $row['time']. "\"> <span style=\"text-align: center;\">".$row['time']. "</span><br/>". $row['task']. "</a></div>";
										    }
										}
										$res->free_result();
									}
